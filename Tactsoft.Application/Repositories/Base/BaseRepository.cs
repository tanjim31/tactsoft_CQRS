    ...
    where T : IEquatable<T>
{
    ...
    public async Task<TModel> GetAsNoTrackingAsync(object id)
    {
    ...
    public async Task<TModel> FirstOrDefaultAsync(object id) => _mapper.Map<TModel>(await DbSet.FindAsync(id));
